...
const NewsApproved = () => {
  ...
  const filteredNewsData = newsData.filter((item)=>item.newsStatus=== "approved")
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="table-responsive">
            ...
            </table>:<p className='d-flex mt-5' style={{alignItems:'center',justifyContent:"center"}}>No News is Published</p> }
          </div>
        </div>
      </div>
    </div>
